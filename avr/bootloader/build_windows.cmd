"C:\Users\%USERNAME%\AppData\Local\Arduino15\packages\DxCore\tools\avr-gcc\7.3.0-atmel3.6.1-azduino7b1\bin\avr-gcc.exe" -x c -funsigned-char -funsigned-bitfields -DUARTTX=C0 -DWDTTIME=1 -DLED=D0 -D__AVR_AVR64DB64__ -DENTRYCOND_REQUIRE=0x34 -DLED_START_FLASHES=20 -DASM_COPY=1 -DASM_UART=1 -DENABLE_CHIP_ERASE=1 -DOTA_COPY=0 -DLED_INVERT  -I"../.."  -Os -ffixed-r20 -ffixed-r21 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -mrelax -g3 -Wall -Wextra -Werror -mmcu=avr64db64 -c -std=gnu11 -MD -MP -MF"bootloader.d" -MT"bootloader.d" -MT"bootloader.o"   -o "bootloader.o" "./optiboot_dx_mod.c" 
